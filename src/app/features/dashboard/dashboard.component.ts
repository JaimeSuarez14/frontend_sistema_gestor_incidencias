...
@Component({
  ...
  imports: [RouterLink],
  template: `
    <div class="space-y-6 dark:bg-gray-800 p-6">
      <div>
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Dashboard</h1>
        <p class="text-gray-500 dark:text-gray-400">Resumen del sistema de incidencias</p>
      </div>

      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div
          class="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border border-gray-100 dark:border-gray-700"
        >
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm text-gray-500 dark:text-gray-400">Total Incidencias</p>
              <p class="text-3xl font-bold text-gray-900 dark:text-white">
                {{ incidentService.totalIncidents() }}
              </p>
            </div>
            <div
              class="w-12 h-12 bg-indigo-100 dark:bg-gray-700 rounded-lg flex items-center justify-center"
            >
              <svg
                class="w-6 h-6 text-indigo-600 dark:text-blue-400"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-red-600 dark:text-red-400">
                {{ incidentService.openIncidents() }}
              </p>
            </div>
            <div
              class="w-12 h-12 bg-red-100 dark:bg-gray-700 rounded-lg flex items-center justify-center"
            >
              <svg
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-amber-600 dark:text-amber-400">
                {{ incidentService.inProgressIncidents() }}
              </p>
            </div>
            <div
              class="w-12 h-12 bg-amber-100 dark:bg-gray-700 rounded-lg flex items-center justify-center"
            >
              <svg
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-3xl font-bold text-green-600 dark:text-green-400">
                {{ incidentService.closedIncidents() }}
              </p>
            </div>
            <div
              class="w-12 h-12 bg-green-100 dark:bg-gray-700 rounded-lg flex items-center justify-center"
            >
              <svg
          ...
          <div class="flex items-center justify-center h-48">
            <div class="flex gap-8">
              <div class="text-center">
                <div
                  class="w-20 h-20 rounded-full border-4 border-red-500 flex items-center justify-center mb-2"
                >
                  <span class="text-xl font-bold text-red-600 dark:text-red-400">
                    {{ incidentService.incidentsByStatus().open }}
                  </span>
                </div>
                <span class="text-sm text-gray-500 dark:text-gray-400">Abiertas</span>
              </div>

              <div class="text-center">
                <div
                  class="w-20 h-20 rounded-full border-4 border-amber-500 flex items-center justify-center mb-2"
                >
                  <span class="text-xl font-bold text-amber-600 dark:text-amber-400">
                    {{ incidentService.incidentsByStatus().in_progress }}
                  </span>
                </div>
              ...
              <div class="text-center">
                <div
                  class="w-20 h-20 rounded-full border-4 border-green-500 flex items-center justify-center mb-2"
                >
                  <span class="text-xl font-bold text-green-600 dark:text-green-400">
                    {{ incidentService.incidentsByStatus().closed }}
                  </span>
                </div>
                <span class="text-sm text-gray-500 dark:text-gray-400">Cerradas</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div>
              <div class="flex justify-between mb-1">
                ...
                <span class="text-sm font-medium text-red-600 dark:text-red-400">
                  {{ incidentService.incidentsByPriority().high }}
                </span>
              </div>
            ...
            <div>
              <div class="flex justify-between mb-1">
                ...
                <span class="text-sm font-medium text-amber-600 dark:text-amber-400">
                  {{ incidentService.incidentsByPriority().medium }}
                </span>
              </div>
              <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                <div
            ...
            <div>
              <div class="flex justify-between mb-1">
                ...
                <span class="text-sm font-medium text-blue-600 dark:text-blue-400">
                  {{ incidentService.incidentsByPriority().low }}
                </span>
              </div>
              <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                <div
      ...
      >
        <div class="flex items-center justify-between mb-4">
          <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Incidencias Recientes</h2>
          <a
            routerLink="/incidents"
            class="text-sm text-indigo-600 dark:text-blue-400 hover:text-indigo-700 dark:hover:text-blue-300"
          >
            Ver todas
          </a>
        </div>
